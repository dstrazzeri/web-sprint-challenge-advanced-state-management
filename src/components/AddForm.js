...
import {fetchSuccess, fetchFail, addSmurf} from '../actions'
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            ...
            props.fetchFail(`Name, position, and nickname are required fields`)
        } else {
...
export default connect(mapStateToProps, { fetchSuccess, fetchFail, addSmurf})(AddForm);
